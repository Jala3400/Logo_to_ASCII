...
-   `-b, --borders <BORDER_CRITERIA>`: Draws borders on the image according to the specified policy. You can specify multiple policies [possible values: color, brightness, alpha, all]
