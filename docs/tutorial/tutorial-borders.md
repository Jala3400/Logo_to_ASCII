...
Something similar happens when working with black logos, but you can detect the borders by using the `-v, --visible` flag.
...
If there are borders close the to the actual borders of the image there might be artifacts. You should check out [this](tutorial-size-position.md#practical-example).
